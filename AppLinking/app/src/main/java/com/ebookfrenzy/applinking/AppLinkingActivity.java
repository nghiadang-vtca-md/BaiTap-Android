...
//https://stackoverflow.com/questions/44497929/digital-assets-link-link-to-my-website
        ...
        if (!idText.getText().equals("")) {
            ...
            if (landmark != null) {
                ...
                */
                ...
                Uri uri = Uri.parse("https://diethealthy.000webhostapp.com/landmarks/" + landmark.getID());
