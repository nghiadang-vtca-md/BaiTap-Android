...
import com.example.database.provider.MyContentProvider;
...
public class MyDBHandler extends SQLiteOpenHelper {
    ...
    // add ContentResolver for using ContentProvider
...
//        db.close();
        ...
        String selection = "productname = \"" + productname + "\"";
        int rowsDeteled = myCR.delete(MyContentProvider.CONTENT_URI, selection, null);
        if (rowsDeteled > 0)
            result = true;
